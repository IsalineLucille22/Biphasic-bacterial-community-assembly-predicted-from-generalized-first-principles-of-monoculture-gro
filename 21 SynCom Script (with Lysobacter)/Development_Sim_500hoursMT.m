...
name_Exp = 'Zenodo_Bruna_500_hours_Predation';
...
% Data_Evol = readtable(strcat('Data/','SynComNX_data_SenkaCB_IG.xlsx'), 'Sheet', 4, 'Range','30:51', 'Format','auto'); %Subcommunities. modified data 57:78. Not modified 30:51
mu_max_dist = table2array(Parameters_Senka_mu_max(:,7:8));
S = height(Data_Evol);
Time_step = [0 12 22 38 70 168 504];%Bruna %[0 1 3 7 10 21]*24;%Senka %[0 24 72 168];%Subcommunities %[0 12 48 96 7*24 21*24];%Clara %Measured time step in hours
nb_res = 12;
...
%save(strcat(cd, '/Data/', name_Exp, 'Stacked_abundances'), 'StackPlot_Meas', 'StackPlotTot')
Struct_Temp = struct();
