...
for nb_iter_tot = 1:1
    ...
    Data_Evol = readtable(strcat('Data/','S20_S21_abs_abund_cfu_Senka.xlsx'), 'Sheet', 12, 'Range','1:22', 'Format','auto');
    % Data_Evol = readtable(strcat('Data/','S20_S21_abs_abund_cfu_Senka.xlsx'), 'Sheet', 12, 'Range','1:22', 'Format','auto');
...
save(strcat(cd, '/Data/', 'Zenodo_data_to_save_SynCom21_Soil_only_Lyso_Parfor'), 'Zenodo_data_to_save_SynCom21_Soil_only_Lyso_Parfor')