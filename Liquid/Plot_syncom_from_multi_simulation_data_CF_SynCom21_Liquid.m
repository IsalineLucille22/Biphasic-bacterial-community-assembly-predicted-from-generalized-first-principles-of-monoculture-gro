...
for zz = 1:nb_rep_sim 
    ...
    sol = ode45(@(t, y) fun_CF_Death_Pred(t, y, kappa_mat, CrossFeed_Mat, Mat_kappa_3, Resource_Matrix, Threshold_CF, Threshold_death,...
    ...
    %No CF
    sol = ode45(@(t, y) fun_CF_Death_Pred(t, y, kappa_mat, 0.*CrossFeed_Mat, Mat_kappa_3, Resource_Matrix, 0.*Threshold_CF, Threshold_death,...
