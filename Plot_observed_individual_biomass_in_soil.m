...
biomass=readtable('MergedData.xlsx','sheet','Growth kinetic params','Range','U3:X24','VariableNamingRule','preserve');

strains=readtable('MergedData.xlsx','sheet','Growth kinetic params','Range','C3:C24','VariableNamingRule','preserve');
...
saveas(figH,'observed-individual-biomass-in-soil.pdf','pdf');
...
Senka=readtable('S20_S21_abs_abund_cfu_Senka.xlsx','sheet','absolute abundances','VariableNamingRule','preserve');
...
cd ../simulations_plots/

saveas(figH,'Fig2D-total-size-monocultures-syncom21.pdf','pdf');

%%starting same way but then with a stacked bar plot as output
