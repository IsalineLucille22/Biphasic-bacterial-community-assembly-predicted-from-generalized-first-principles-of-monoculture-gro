...
S = height(Data_Evol);
Time_step = [0 12 22 38 70 168 504];%Bruna %Measured time step in hours
...
for zz = 1:nb_rep_sim %nb_rep %nb_data_set
    ...
    mean_y_0(16) = 0; %For Metatranscriptomics data, no microbacterium
