...
y_0_mean_T = load(strcat(dataFolder, name_Exp, 'mean_y_0_T.mat'));%load(strcat('Data/', 'Phil_SynCom21_21wk_Paper_Transfer_Predation_Set_Obs_y0mean_y_0_T.mat'));%load(strcat('Data/', name_Exp, 'mean_y_0_T.mat'));
y_0_mean_T = y_0_mean_T.mean_y_0_T;

%actual absolute abundance data, has quadriplicate values for each time point
Data_Evol_tot = readtable(strcat(dataFolder,'S20_S21_abs_abund_cfu_Senka.xlsx'), 'Sheet', 13, 'Range','1:22', 'Format','auto'); %Phil's weekly data
